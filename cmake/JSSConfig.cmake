...
macro(jss_config_cflags)
    ...
    endforeach()
    foreach(NSPR_INCLUDE_DIR in ${NSPR_INCLUDE_DIRS})
        list(APPEND JSS_RAW_C_FLAGS "-I${NSPR_INCLUDE_DIR}")
    endforeach()
    foreach(NSS_INCLUDE_DIR in ${NSS_INCLUDE_DIRS})
        list(APPEND JSS_RAW_C_FLAGS "-I${NSS_INCLUDE_DIR}")
    endforeach()
    foreach(NSPR_LIBRARY in ${NSPR_LIBRARIES})
        list(APPEND JSS_RAW_C_FLAGS "-L${NSPR_LIBRARY}")
    endforeach()
    foreach(NSS_LIBRARY in ${NSS_LIBRARIES})
